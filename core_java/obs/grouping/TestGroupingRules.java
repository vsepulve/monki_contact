...
public class TestGroupingRules{
	
	public TestGroupingRules(){
	}
	...
	public Set<Grouping> execute(Map<Integer, Group> news, 
		...
		System.out.println("TestGroupingRules - start");
		Date d_ini;
		Date d_end;
...
//			Iterator<Integer> it = converted_candidates.iterator();
		...
		System.out.println("TestGroupingRules - end "+(long)(d_end.getTime()-d_ini.getTime())/1000+" s");
