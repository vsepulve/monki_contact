...
import obs.grouping.TestGroupingRules;
...
public class TestProcessingCell implements Runnable{
	...
	public TestProcessingCell(String _host, String _bd, String _user, String _pass, 
...
//		comm_interface.open();
		...
		TestGroupingRules grouping = new TestGroupingRules();
		...
		if(! comm_interface.open() ){
			...
			System.out.println("ProcessingCell.run "+id+" - Guardando cambios en BD (temporalemten desactivado)");
